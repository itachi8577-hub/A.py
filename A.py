...
# ============== RENDER PORT (SIRF YAHI ADD KIYA HAI) ==============
...
# =====================================================================
# 🌐 WEB SERVER FOR RENDER (SIRF YAHI ADD KIYA HAI)
# =====================================================================
...
async def start_web_server():
    """Start aiohttp web server on Render PORT"""
    app = web.Application()
...
# =====================================================================
# 🚀 MAIN FUNCTION WITH WEB SERVER
# =====================================================================
async def main():
    # Start web server for Render (SIRF YAHI ADD KIYA HAI)
...
if __name__ == "__main__":
    # Start both web server and bot together
